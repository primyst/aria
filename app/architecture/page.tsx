      ...
      <section className="w-full px-5 py-6 sm:px-8 md:px-12 lg:px-16">
        <div className="mx-auto max-w-[1440px]">
          <header className="flex items-center justify-between border-b border-[#2c2925]/10 pb-6">
            ...
            <a
              href="#contact"
              className="rounded-full bg-[#2c2925] px-5 py-2.5 text-[13px] font-medium text-white transition hover:opacity-90"
            >
              Get in touch
            </a>
          </header>
          ...
          <div id="top" className="grid min-h-[calc(100vh-100px)] grid-cols-1 items-center gap-12 py-12 md:grid-cols-2 md:gap-16 md:py-16 lg:gap-24">
            <div>
              <motion.h1
                ...
                className="max-w-2xl text-[42px] font-semibold leading-[1.04] tracking-[-0.04em] sm:text-[52px] lg:text-[64px]"
              >
              ...
              <motion.p
                ...
                className="mt-6 max-w-md text-[15px] leading-relaxed text-[#2c2925]/60"
              >
              ...
              >
                <a href="#selected-work" className="rounded-full bg-[#2c2925] px-6 py-3 text-[14px] font-medium text-white transition hover:opacity-90">
                  View projects
                </a>
                <a href="#journal" className="flex items-center gap-2 text-[14px] font-medium">
                  <span className="flex h-8 w-8 items-center justify-center rounded-full border border-[#2c2925]/20">↗</span>
                  Studio journal
                </a>
              </motion.div>
              ...
              <motion.div
                ...
                className="mt-12 flex gap-8 border-t border-[#2c2925]/10 pt-6 sm:gap-12"
              >
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="aspect-[4/5] w-full overflow-hidden rounded-[20px] md:aspect-[4/5]">
                <img src={IMAGE_URL} alt="Cantilevered glass and steel residence" className="h-full w-full object-cover" />
              </div>
              <motion.div
        ...
        <div className="mx-auto max-w-[1440px]">
          <div className="grid gap-8 border-b border-[#2c2925]/10 pb-10 md:grid-cols-[1fr_2fr] md:items-end md:gap-16">
            <div className="flex items-center gap-3 text-[11px] font-medium tracking-[0.18em] text-[#2c2925]/45">
              <span>SELECTED WORK</span><span className="h-px w-10 bg-[#2c2925]/20" /><span>03 PROJECTS</span>
            </div>
            <p className="max-w-3xl text-[25px] leading-[1.16] tracking-[-0.02em] md:text-[36px]">
              Architecture shaped by place, material, light and the lives lived within it.
            </p>
          </div>
          ...
          >
            <div className="group overflow-hidden rounded-[20px] bg-[#eeeae3]">
              <div className="aspect-[16/9] overflow-hidden md:aspect-[2.05/1]">
                <img src={PROJECT_IMAGES.lindoya} alt="Modern house with natural stone, concrete and expansive windows" className="h-full w-full object-cover transition duration-700 ease-out group-hover:scale-[1.02]" />
              </div>
            </div>
            <div className="mt-6 grid gap-6 md:grid-cols-[1fr_auto] md:items-start">
              <div>
                <div className="flex flex-wrap items-baseline gap-x-4 gap-y-1">
                  <h2 className="text-[25px] font-semibold tracking-tight">Lindøya House</h2>
                  <p className="text-[13px] text-[#2c2925]/45">Oslo, Norway · Residential · 2025</p>
                </div>
          ...
          <div className="mt-20 grid gap-16 md:mt-28 md:grid-cols-12 md:gap-8">
            ...
            >
              ...
              <div className="mt-5">
                <div className="flex flex-wrap items-baseline gap-x-3 gap-y-1"><h3 className="text-[20px] font-semibold tracking-tight">Casa da Luz</h3><p className="text-[12px] text-[#2c2925]/45">Lisbon, Portugal · Residential · 2024</p></div>
                <p className="mt-2 max-w-md text-[13px] leading-relaxed text-[#2c2925]/50">A compact urban house organized around light, privacy and outdoor living.</p>
                <a href="#casa-da-luz" className="mt-4 inline-flex items-center gap-2 text-[12px] font-medium">Explore project <span>↗</span></a>
              </div>
            </motion.article>
            ...
            >
              ...
              <div className="mt-5">
                <div className="flex flex-wrap items-baseline gap-x-3 gap-y-1"><h3 className="text-[20px] font-semibold tracking-tight">Fjord Pavilion</h3><p className="text-[12px] text-[#2c2925]/45">Norway · Cultural · 2025</p></div>
                <p className="mt-2 max-w-md text-[13px] leading-relaxed text-[#2c2925]/50">A small public pavilion where timber, stone and landscape create a quiet threshold between city and nature.</p>
                <a href="#fjord-pavilion" className="mt-4 inline-flex items-center gap-2 text-[12px] font-medium">Explore project <span>↗</span></a>
              </div>
            </motion.article>
          </div>
